...
Revision ID: 6f00da11c45f
Revises: 21fe7ef34152
Create Date: 2020-10-21 17:53:35.748576
...
revision = '6f00da11c45f'
down_revision = '21fe7ef34152'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('complete', 'incomplete'), server_default='incomplete', nullable=False),
